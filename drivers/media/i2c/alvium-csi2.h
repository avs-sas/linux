...
#define REG_BCRM_DEVICE_GUID_R				CCI_REG64_LE(0x0018)
#define REG_BCRM_DEVICE_MODEL_NAME_R			CCI_REG64_LE(0x0098)
#define REG_BCRM_DEVICE_FAMILY_NAME_R			CCI_REG64_LE(0x00d8)
#define REG_BCRM_DEVICE_SERIAL_NUMBER_R			CCI_REG64_LE(0x0198)
...
#define ALVIUM_FW_GET_LANE_CNT_I2C_R \
